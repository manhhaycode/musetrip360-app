  ...
  build: {
    lib: {
      entry: {
        ...
        canvas: resolve(__dirname, 'lib/canvas/index.ts'),
    ...
    rollupOptions: {
      ...
      output: {
        ...
        entryFileNames: (chunkInfo) => {
          ...
          if (chunkInfo.name === 'canvas') {
            return '[format]/canvas/index.js';
          }
          if (chunkInfo.name === 'components') {
            return '[format]/components/index.js';
          }
          if (chunkInfo.name === 'hooks') {
            return '[format]/hooks/index.js';
          }
          if (chunkInfo.name === 'store') {
            return '[format]/store/index.js';
          }
          ...
          // while still providing a consistent output structure
