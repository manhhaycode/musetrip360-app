      ...
      <View className="flex-1 items-center justify-center px-4">
        <Card className="bg-green-50 border border-green-200 rounded-lg w-full max-w-md">
          <CardContent className="p-6 items-center">
            ...
            <Text className="text-2xl font-bold text-green-800 mt-4 mb-2 text-center">Thanh toán thành công!</Text>
            ...
            <View className="w-full space-y-3">
              <Button
                onPress={() => router.replace('/(tabs)/profile?tab=events' as any)}
                className="bg-green-600 w-full p-3 rounded-lg"
              >
                <Text className="text-white font-medium text-center">Xem sự kiện của tôi</Text>
              </Button>

              <Button onPress={() => router.replace('/(tabs)/' as any)} className="bg-gray-200 w-full p-3 rounded-lg">
