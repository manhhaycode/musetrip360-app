...
import { toggleTextVariants, toggleVariants } from '@/components/core/ui/toggle';
import { TextClassContext } from '@/components/core/ui/text';
...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root className={cn('flex flex-row items-center justify-center gap-1', className)} {...props}>
