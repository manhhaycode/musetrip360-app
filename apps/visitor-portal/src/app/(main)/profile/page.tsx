...
import { z } from 'zod';
import { Loader2, Edit, Save, X, User, Lock } from 'lucide-react';
...
const profileUpdateSchema = z.object({
  ...
  phoneNumber: z
    ...
    .refine((val) => {
      ...
      const phoneRegex = /^(\+84|84|0)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$/;
  ...
  return (
    <div className="max-w-4xl mx-auto px-8 py-6">
      ...
      <div className="my-8">
        ...
        {/* Error Message */}
        {updateError && (
          <div className="animate-in slide-in-from-top-1 duration-200 rounded-md bg-red-50 p-3 text-sm text-red-800 border border-red-200 mb-4">
            {updateError}
          </div>
        )}
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <span className="ml-2 font-mono text-sm text-gray-500">{user.id}</span>
          </div>
          <div>
